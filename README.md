...
Full, heavily-commented versions of these tools — Python, TypeScript, Ruby, and CLI — are in [`examples/`](examples/), with notes on how an agent invokes a tool and why the guard goes *inside* it.
